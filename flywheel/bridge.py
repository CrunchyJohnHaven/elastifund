"""Bridge existing Polymarket bot SQLite state into a flywheel payload."""
...
def build_payload_from_bot_db(
    ...
    *,
    ...
    """Construct a cycle payload for one strategy from the live bot SQLite DB."""
...
def write_payload(payload: dict[str, Any], output_path: str | Path) -> str:
    """Write the generated payload to disk."""
