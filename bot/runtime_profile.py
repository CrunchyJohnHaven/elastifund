...
def _profile_to_effective_env(profile: RuntimeProfile) -> dict[str, str]:
    effective_env = {
        ...
        "JJ_ENABLE_POLYMARKET_VENUE": _bool_str(profile.feature_flags.enable_polymarket_venue),
        "JJ_ENABLE_KALSHI_VENUE": _bool_str(profile.feature_flags.enable_kalshi_venue),
        ...
        "JJ_HOURLY_NOTIONAL_BUDGET_USD": str(profile.risk_limits.hourly_notional_budget_usd),
