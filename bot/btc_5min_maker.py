...
class MakerConfig:
    ...
    risk_fraction: float = float(os.environ.get("BTC5_RISK_FRACTION", "0.01"))
    max_trade_usd: float = float(os.environ.get("BTC5_MAX_TRADE_USD", "2.50"))
    min_trade_usd: float = float(os.environ.get("BTC5_MIN_TRADE_USD", "0.25"))
    ...
    daily_loss_limit_usd: float = float(os.environ.get("BTC5_DAILY_LOSS_LIMIT_USD", "5"))
