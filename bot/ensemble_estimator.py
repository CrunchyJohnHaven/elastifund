...
# Default to Groq free tier for ensemble diversity — $0 cost
OPENAI_MODEL_DEFAULT = os.environ.get("JJ_OPENAI_ENSEMBLE_MODEL", "llama-3.3-70b-versatile")
OPENAI_BASE_URL = os.environ.get("JJ_OPENAI_ENSEMBLE_BASE_URL", "https://api.groq.com/openai/v1")
OPENAI_API_KEY_ENV = os.environ.get("JJ_OPENAI_ENSEMBLE_API_KEY_ENV", "GROQ_API_KEY")
OPENAI_INPUT_COST_PER_M = float(os.environ.get("JJ_OPENAI_INPUT_COST_PER_M", "0.0"))
OPENAI_OUTPUT_COST_PER_M = float(os.environ.get("JJ_OPENAI_OUTPUT_COST_PER_M", "0.0"))
