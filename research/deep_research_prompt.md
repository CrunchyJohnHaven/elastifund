...
| 5 | docs/strategy/edge_discovery_system.md | Hypothesis testing pipeline |
| 6 | FAST_TRADE_EDGE_ANALYSIS.md | Current pipeline state (REJECT ALL) |
| 7 | research/deep_research_output.md | 100-strategy taxonomy, A-6 and B-1 source specs |
| 8 | research/jj_assessment_dispatch.md | JJ's prioritization and kill decisions |
