...
**Retention note (2026-03-11):** snapshot trees under `snapshots/` are local archive artifacts and are ignored by default in git.
**Size:** 9.5 MB
...
| `snapshots/20260305_2243/` | **CREATED** — Baseline snapshot directory (local archive; untracked by default) |
