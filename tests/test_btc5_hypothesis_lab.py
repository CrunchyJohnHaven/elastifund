...
def test_frontier_selection_prefers_realistic_probe_over_thin_arr_spike() -> None:
    active_candidate = {
        "name": "active_profile",
        "validation_median_arr_pct": 100.0,
        "validation_p05_arr_pct": 50.0,
        ...
        [
            {
                ...
                "summary": {
                    ...
                    "generalization_ratio": 0.45,
                    "validation_median_arr_pct": 400.0,
                    "validation_p05_arr_pct": 210.0,
                },
            },
            {
                "hypothesis": {
                ...
                "summary": {
                    ...
                    "validation_median_arr_pct": 220.0,
                    "validation_p05_arr_pct": 110.0,
                },
            },
        ],
        active_candidate=active_candidate,
    ...
    assert [item["name"] for item in follow_ups[:2]] == ["realistic_probe", "thin_arr_spike"]
    assert follow_ups[0]["frontier_selection_score"] > follow_ups[1]["frontier_selection_score"]
...
def test_candidate_from_profile_result_exposes_standard_summary_fields() -> None:
    ...
    candidate = _candidate_from_profile_result(
        ...
        evaluated={
            ...
            "summary": {
                ...
                "validation_profit_probability": 0.61,
                "validation_p95_drawdown_usd": 3.2,
            },
        },
    )
    ...
    assert candidate["validation_profit_probability"] == 0.61
    assert candidate["validation_p95_drawdown_usd"] == 3.2
