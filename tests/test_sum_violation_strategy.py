...
class TestSumViolationStrategy(unittest.TestCase):
    ...
    def test_fee_subtraction_kills_thin_violations(self) -> None:
        strategy = SumViolationStrategy(
            scanner=DummyScanner([self._opportunity(violation_id="sig-fee", category="sports", resolution_hours=4.0)]),
            threshold=0.001,
            min_depth_usd=50.0,
        ...
        self.assertEqual(strategy.last_evaluations[0].reason, "fee_drag")
