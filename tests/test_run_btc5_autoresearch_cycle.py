...
def test_render_override_env_contains_promoted_values() -> None:
    text = _render_override_env(
        {"name": "grid", "max_abs_delta": 0.0001, "up_max_buy_price": 0.48, "down_max_buy_price": 0.50},
