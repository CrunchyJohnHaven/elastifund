#!/usr/bin/env python3
"""[Historical Utility] Run the full expanded backtest pipeline after Claude cache is populated.
...
Prefer `python3 -m backtest.run_scale_comparison` and `python3 -m backtest.run_combined`
for current canonical replay and reporting.
"""
import json
import os
import sys
...
# Ensure imports work from historical subdir
