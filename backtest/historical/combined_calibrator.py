"""[Historical Utility] Combined calibrator: stacks the best improvements together.
...
This is kept for historical reproducibility; current canonical lane-level evidence
and reporting should use `backtest.run_scale_comparison` and `backtest.run_combined`.
"""
...
# Ensure historical script can import sibling backtest modules.
