...
TASK: Refresh `COMMAND_NODE.md`, `PROJECT_INSTRUCTIONS.md`, and `docs/REPO_MAP.md` to reflect all changes made today. Together they form the canonical context package for new AI sessions and need to stay current and compact.

Read these files first:
- CLAUDE.md (new — JJ persona, prime directive, autonomous execution mandate)
- docs/strategy/flywheel_strategy.md (rewritten — 6-phase flywheel, website vision, dual mission)
...
```
You are working on the Elastifund repo. Read CLAUDE.md and docs/strategy/flywheel_strategy.md first.
...
- Use the diary template from docs/strategy/flywheel_strategy.md (Day N, What We Did, Strategy Updates, Key Numbers, What We Learned, Tomorrow's Plan)
