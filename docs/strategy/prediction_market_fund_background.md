...
- **`polymarket_llm_bot_background.md`** — GPT-4.5 deep research: market category rankings, academic literature (Halawi et al., Clinton & Huang, Karger et al.), competitive landscape (OpenClaw, Dysrupt Labs, PolyScripts), data feed recommendations
