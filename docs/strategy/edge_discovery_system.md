...
This is the canonical strategy-surface build spec for the current edge research engine.
...
4. Live posture machine truth: `reports/remote_cycle_status.json` and `reports/remote_service_status.json`
