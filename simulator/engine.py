...
Prefer importing this engine via ``simulator.api`` in new code.
"""
...
if __package__ in {None, ""}:  # pragma: no cover - script compatibility
    ...
    from simulator.fill_model import FillResult, simulate_fill
    from simulator.metrics import SimulationReport, TradeRecord, build_report
    from simulator.sizing import compute_position_size
