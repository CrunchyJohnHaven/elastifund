"""Frozen evaluator wrapper for the BTC5 command-node benchmark v4 lane."""
...
def _benchmark_id(manifest_path_value: str | Path) -> str:
    ...
    try:
        ...
        return "command_node_btc5_v4"
    return str(manifest.get("benchmark_id") or "command_node_btc5_v4")
